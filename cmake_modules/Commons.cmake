...
macro(set_common_cxx_flags_for_redex)
    ...
    if (MSVC)
        ...
        if (UNIX AND NOT APPLE AND ENABLE_STATIC)
            set(CMAKE_LTO_FLAG "-flto")
            set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -static-libgcc -static-libstdc++ -flto")
        elseif (MINGW)
            set(CMAKE_LTO_FLAG "")
            set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -static -static-libgcc -static-libstdc++")
        endif ()

        set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -g -Wall -pthread ${CMAKE_LTO_FLAG}")
        set(COMMON_CXX_FLAGS_NODBG "-O3 -UNDEBUG ${CMAKE_LTO_FLAG}")
