...
macro(set_common_cxx_flags_for_redex)
    ...
    if (MSVC)
        ...
        elseif (MINGW)
            set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -static -static-libgcc -static-libstdc++ -mcmodel=medium")
        endif ()

        set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -g -Wall -pthread -mcmodel=medium")
        set(COMMON_CXX_FLAGS_NODBG "-O3 -UNDEBUG -mcmodel=medium")
