...
macro(set_common_cxx_flags_for_redex)
    ...
    if (MSVC)
        ...
        if (ENABLE_STATIC)
            set(CMAKE_FPIC_FLAG "-fPIC")
        else ()
            set(CMAKE_FPIC_FLAG "")
        endif ()

        set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -g -Wall -pthread ${CMAKE_FPIC_FLAG}")
        set(COMMON_CXX_FLAGS_NODBG "-O3 -UNDEBUG ${CMAKE_FPIC_FLAG}")
