...
void MethodInlinePass::bind_config() {
  ...
  bind("inline_hot_callsite_count_percentile",
       ...
       m_inliner_cost_config.inline_hot_callsite_count_percentile,
  ...
  bind("inline_hot_callsite_count_discount",
       ...
       m_inliner_cost_config.inline_hot_callsite_count_discount,
  ...
  bind("inline_hot_callsite_count_top_percentile",
       ...
       m_inliner_cost_config.inline_hot_callsite_count_top_percentile,
  ...
  bind("inline_hot_callsite_count_top_discount",
       ...
       m_inliner_cost_config.inline_hot_callsite_count_top_discount,
