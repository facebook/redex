...
class NativeOutliner : public Pass {
 public:
  NativeOutliner() : Pass("NativeOutlinerPass") {}
  ...
  virtual void configure_pass(const PassConfig& pc) override {
    ...
    pc.get("dont_outline_types", {}, m_dont_outline_types);
    pc.get("artifacts_file", "outliner-artifacts.bin", m_artifacts_filename);
  }
 ...
 private:
  std::vector<std::string> m_dont_outline_types;
  bool m_outline_primary_dex;
  std::string m_artifacts_filename;
};
