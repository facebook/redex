...
template <class TYPE>
inline SortedVector<TYPE>& SortedVector<TYPE>::operator=(
...
template <class TYPE>
void SortedVector<TYPE>::do_copy(void* dest,
                                 const void* from,
                                 size_t num) const {
...
template <class TYPE>
void SortedVector<TYPE>::do_splat(void* dest,
                                  const void* item,
                                  size_t num) const {
...
template <class TYPE>
void SortedVector<TYPE>::do_move_forward(void* dest,
                                         const void* from,
                                         size_t num) const {
...
template <class TYPE>
void SortedVector<TYPE>::do_move_backward(void* dest,
                                          const void* from,
                                          size_t num) const {
