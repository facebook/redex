...
std::string show(const IRCode*, bool code_only = false);
std::string show(const cfg::Block* block, bool code_only = false);
std::string show(const cfg::ControlFlowGraph&, bool code_only = false);
