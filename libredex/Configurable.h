...
DEFINE_CONFIGURABLE_PRIMITIVE(double)
DEFINE_CONFIGURABLE_PRIMITIVE(bool)
DEFINE_CONFIGURABLE_PRIMITIVE(std::optional<bool>)
...
DEFINE_CONFIGURABLE_PRIMITIVE(const DexType*)
...
DEFINE_CONFIGURABLE_PRIMITIVE(std::vector<const DexType*>)
...
DEFINE_CONFIGURABLE_PRIMITIVE(
    SINGLE_ARG(UnorderedMap<const DexType*, const DexType*>))
DEFINE_CONFIGURABLE_PRIMITIVE(
