...
class RClassReader {
 public:
  explicit RClassReader(ResourceConfig global_resources_config)
      : m_global_resources_config(std::move(global_resources_config)) {}
...
class RClassWriter {
 public:
  explicit RClassWriter(ResourceConfig global_resources_config)
      : m_global_resources_config(std::move(global_resources_config)) {}
