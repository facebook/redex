...
TEST_F(PostVerify, InlineWithFinalField) {
  ...
  auto expected = assembler::ircode_from_string(R"((
      ...
      (iput v2 v5 "Lcom/facebook/redexinline/WithFinalField;.finalField:I")
      (const v0 0)
      (sput v0 "Lredex/$StoreFenceHelper;.DUMMY_VOLATILE:I")
      (iget v5 "Lcom/facebook/redexinline/WithFinalField;.finalField:I")
      ...
      (invoke-virtual (v0 v2) "Lorg/assertj/core/api/AbstractIntegerAssert;.isEqualTo:(I)Lorg/assertj/core/api/AbstractIntegerAssert;")
      (return-void)
  ))");
