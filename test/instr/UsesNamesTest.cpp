...
TEST_F(PreVerify, UsesNames) {
  ...
  // Sub class of A
  auto* suba =
      find_class_named(classes, "Lcom/facebook/redex/test/instr/SubA;");
  ...
  // Sub class of B
  auto* subb =
      find_class_named(classes, "Lcom/facebook/redex/test/instr/SubB;");
  ...
  // Base Subclass C
  auto* subc =
      find_class_named(classes, "Lcom/facebook/redex/test/instr/SubC;");
