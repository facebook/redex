...
TEST_F(ReflectionAnalysisTest, constClass) {
  ...
  EXPECT_EQ(to_string(analysis.get_reflection_sites()),
            "CONST_CLASS LFoo; {4294967294, CLASS{LFoo;}(REFLECTION)}\n"
            "IOPCODE_MOVE_RESULT_PSEUDO_OBJECT v1 {1, CLASS{LFoo;}(REFLECTION);4294967294, CLASS{LFoo;}(REFLECTION)}\n");
  // clang-format on
}
...
TEST_F(ReflectionAnalysisTest, classForName) {
  ...
  // clang-format off
  EXPECT_EQ(to_string(analysis.get_reflection_sites()),
            "INVOKE_STATIC v1, Ljava/lang/Class;.forName:(Ljava/lang/String;)Ljava/lang/Class; {4294967294, CLASS{LFoo;}(REFLECTION)}\n"
            "MOVE_RESULT_OBJECT v0 {0, CLASS{LFoo;}(REFLECTION);4294967294, CLASS{LFoo;}(REFLECTION)}\n");
  // clang-format on
}
...
TEST_F(ReflectionAnalysisTest, getClassOnField) {
  ...
  // clang-format off
  EXPECT_EQ(to_string(analysis.get_reflection_sites()),
            "INVOKE_VIRTUAL v1, Ljava/lang/Object;.getClass:()Ljava/lang/Class; {4294967294, CLASS{Ljava/lang/String;}(REFLECTION)}\n"
            "MOVE_RESULT_OBJECT v1 {1, CLASS{Ljava/lang/String;}(REFLECTION);4294967294, CLASS{Ljava/lang/String;}(REFLECTION)}\n");
  // clang-format on
}
...
TEST_F(ReflectionAnalysisTest, getMethod) {
  ...
  EXPECT_EQ(
      ...
      "CONST_CLASS LFoo; {4294967294, CLASS{LFoo;}(REFLECTION)}\n"
      "IOPCODE_MOVE_RESULT_PSEUDO_OBJECT v1 {1, CLASS{LFoo;}(REFLECTION);4294967294, CLASS{LFoo;}(REFLECTION)}\n"
      "CONST_STRING \"bar\" {1, CLASS{LFoo;}(REFLECTION)}\n"
      ...
      "INVOKE_VIRTUAL v1, v2, v3, Ljava/lang/Class;.getMethod:(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method; {1, CLASS{LFoo;}(REFLECTION);4294967294, METHOD{LFoo;:bar}}\n"
      "MOVE_RESULT_OBJECT v4 {1, CLASS{LFoo;}(REFLECTION);4, METHOD{LFoo;:bar};4294967294, METHOD{LFoo;:bar}}\n");
  // clang-format on
}
...
TEST_F(ReflectionAnalysisTest, getField) {
  ...
  EXPECT_EQ(
      ...
      "CONST_STRING \"bar\" {1, CLASS{LFoo;}(REFLECTION)}\n"
      "IOPCODE_MOVE_RESULT_PSEUDO_OBJECT v2 {1, CLASS{LFoo;}(REFLECTION)}\n"
      "INVOKE_VIRTUAL v1, v2, Ljava/lang/Class;.getField:(Ljava/lang/String;)Ljava/lang/reflect/Field; {1, CLASS{LFoo;}(REFLECTION);4294967294, FIELD{LFoo;:bar}}\n"
      "MOVE_RESULT_OBJECT v4 {1, CLASS{LFoo;}(REFLECTION);4, FIELD{LFoo;:bar};4294967294, FIELD{LFoo;:bar}}\n");
  // clang-format on
}
...
TEST_F(ReflectionAnalysisTest, instanceOf) {
  ...
  EXPECT_EQ(
      to_string(analysis.get_reflection_sites()),
      "INVOKE_VIRTUAL v6, Ljava/lang/Object;.getClass:()Ljava/lang/Class; {4294967294, CLASS{Ljava/lang/Object;(LFoo;)}(REFLECTION)}\n"
      "MOVE_RESULT_OBJECT v2 {2, CLASS{Ljava/lang/Object;(LFoo;)}(REFLECTION);4294967294, CLASS{Ljava/lang/Object;(LFoo;)}(REFLECTION)}\n"
      "CONST_STRING \"bar\" {2, CLASS{Ljava/lang/Object;(LFoo;)}(REFLECTION)}\n"
      "IOPCODE_MOVE_RESULT_PSEUDO_OBJECT v3 {2, CLASS{Ljava/lang/Object;(LFoo;)}(REFLECTION)}\n"
      "INVOKE_VIRTUAL v2, v3, Ljava/lang/Class;.getField:(Ljava/lang/String;)Ljava/lang/reflect/Field; {2, CLASS{Ljava/lang/Object;(LFoo;)}(REFLECTION);4294967294, FIELD{Ljava/lang/Object;(LFoo;):bar}}\n"
      "MOVE_RESULT_OBJECT v4 {2, CLASS{Ljava/lang/Object;(LFoo;)}(REFLECTION);4, FIELD{Ljava/lang/Object;(LFoo;):bar};4294967294, FIELD{Ljava/lang/Object;(LFoo;):bar}}\n");
  // clang-format on
}
