...
const uint32_t kLayoutMarginBottom = 0x010100fa;
const uint32_t kLineSpacingMultiplier = 0x1010218;
const uint32_t kLayoutMargin = 0x010100f6;
const uint32_t kTextAllCaps = 0x101038c;
const uint32_t kElevation = 0x1010440;
const uint32_t kStackFromBottom = 0x10100fd;
const uint32_t kDuplicateParentState = 0x10100e9;
const uint32_t kIsGame = 0x10103f4;
const uint32_t kPaddingStart = 0x10103b3;
const uint32_t kFontFamily = 0x10103ac;
