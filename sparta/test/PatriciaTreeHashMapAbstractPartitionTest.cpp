...
using Partition = PatriciaTreeHashMapAbstractPartition<uint32_t, Domain>;

INSTANTIATE_TYPED_TEST_SUITE_P(PatriciaTreeHashMapAbstractPartition,
...
TEST(PatriciaTreeHashMapAbstractPartitionTest, basicPartialOrders) {
  {
    Partition p1;
...
TEST(PatriciaTreeHashMapAbstractPartitionTest, latticeOperations) {
  Partition p1({{1, Domain({"a", "b"})},
                {2, Domain("c")},
                {3, Domain({"d", "e", "f"})},
                {4, Domain({"a", "f"})}});
...
TEST(PatriciaTreeHashMapAbstractPartitionTest, destructiveOperations) {
  Partition p1({{1, Domain({"a", "b"})}});
...
TEST(PatriciaTreeHashMapAbstractPartitionTest, transform) {
  ...
  p1.transform([](Domain* d) { d->set_to_bottom(); });
