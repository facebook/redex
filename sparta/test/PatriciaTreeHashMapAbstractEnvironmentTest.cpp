...
using Environment = PatriciaTreeHashMapAbstractEnvironment<uint32_t, Domain>;

class PatriciaTreeHashMapAbstractEnvironmentTest : public ::testing::Test {
 protected:
  PatriciaTreeHashMapAbstractEnvironmentTest()
      : m_rd_device(),
...
TEST_F(PatriciaTreeHashMapAbstractEnvironmentTest, latticeOperations) {
...
TEST_F(PatriciaTreeHashMapAbstractEnvironmentTest, destructiveOperations) {
  Environment e1({{1, Domain({"a", "b"})}});
...
TEST_F(PatriciaTreeHashMapAbstractEnvironmentTest, robustness) {
...
TEST_F(PatriciaTreeHashMapAbstractEnvironmentTest, whiteBox) {
  ...
  e.update(1, [](Domain* x) { *x = Domain({"a"}); });
...
TEST_F(PatriciaTreeHashMapAbstractEnvironmentTest, prettyPrinting) {
  using StringEnvironment =
      PatriciaTreeHashMapAbstractEnvironment<std::string*, Domain>;
  std::string a = "a";
