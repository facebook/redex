...
namespace redex {
  ...
  using namespace std;
    ...
    public:
      Annotation(unsigned int line_number, string anno) : Token(token::annotation, line_number) {};
    ...
    public:
      string command_name;
      Command(unsigned int line_number, string cmd) : Token(token::command, line_number), command_name{cmd} {}
    ...
    public:
      string ident;
      Identifier(unsigned int line_number, string idenifier) : Token(token::identifier, line_number), ident{idenifier} {}
    ...
    public:
      string path;
      Filepath(unsigned int line_number, string file) : Token(token::filepath, line_number), path{file} {}
    ...
    public:
      ...
      TargetVersion (unsigned int line_number, string version) : Token(token::target_version_token, line_number), target_version{version} {} ;
    ...
    public:
      string filter;
      Filter(unsigned int line_number, string pattern) : Token(token::filter_pattern, line_number), filter{pattern} {}
    ...
    public:
      ...
      UnknownToken(string token_text, unsigned int line_number) : Token(token::unknownToken, line_number), token_string{token_text} {}
    };
